...
| Field | Value |
|---|---|
| Experiment type | rq2_refined_category_feedback |
...
| Base random seed | 201 |
| Per-run seeds | 201, 202, 203, 204 |
| Number of runs | 4 |
| Examples per run | 500 |
| Maximum refinement iterations | 5 |
| Execution timestamp (UTC) | 2026-09-06T14:24:13.860368+00:00 |
| Executed command line | `scripts/run_dart_rq2_refinement.py --iterations 5 --examples 500 --artifact-dir artifacts/repeated/rq2-loop-category-feedback --seed 201 --runs 4 --category-feedback` |
