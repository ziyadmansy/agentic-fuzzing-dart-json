...
| Base random seed | 4 |
| Per-run seeds | 4, 5, 6, 7 |
| Number of runs | 4 |
| Examples per run | 500 |
| Maximum refinement iterations | 5 |
| Execution timestamp (UTC) | 2026-09-06T00:48:38.265161+00:00 |
| Executed command line | `scripts/run_dart_rq2_refinement.py --iterations 5 --examples 500 --artifact-dir artifacts/repeated/rq2-loop-run01 --seed 4 --runs 4` |
