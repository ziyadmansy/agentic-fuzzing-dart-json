...
| Base random seed | 0 |
| Per-run seeds | 0, 1, 2, 3, 4 |
| Number of runs | 5 |
| Examples per run | 500 |
| Maximum refinement iterations | not applicable |
| Execution timestamp (UTC) | 2026-09-06T07:35:43.993118+00:00 |
| Executed command line | `scripts/run_dart_rq1_baseline.py --examples 500 --artifact-dir artifacts/repeated/rq1-baseline-n5 --seed 0 --runs 5` |
