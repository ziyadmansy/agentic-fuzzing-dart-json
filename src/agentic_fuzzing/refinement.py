...
Ported unchanged from the original agentic-grammar-fuzzing project except for
this import line: `run_campaign` now comes from `dart_campaign` (a batch
harness client, docs/dart-oracle-design.md Section 9) instead of the
original's per-input-subprocess `campaign` module. Nothing else in this file
is C/cJSON-specific, so nothing else changed.
"""
...
from .dart_campaign import run_campaign
