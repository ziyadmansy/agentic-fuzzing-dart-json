...
| Per-run seeds | 101, 102, 103, 104 |
| Number of runs | 4 |
| Examples per run | 500 |
| Maximum refinement iterations | 5 |
| Execution timestamp (UTC) | 2026-09-06T13:49:57.982433+00:00 |
| Executed command line | `scripts/run_dart_rq2_refinement.py --iterations 5 --examples 500 --artifact-dir artifacts/repeated/rq2-loop-json-allowed --seed 101 --runs 4 --allow-json` |
